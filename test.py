...
def main():
    ...
    opts["img_to_load"] = -1
    test_loader = dataset_loader.load_istd_dataset(ws_istd, ns_istd, mask_istd, 32, opts)
    ...
    with torch.no_grad():
        ...
        rmse_val_s = []
        rmse_val_ns = []
        for ii, (file_name, rgb_ws, rgb_ns, shadow_matte) in enumerate(tqdm(test_loader), 0):
            ...
            print("RGB restored shape:", np.shape(rgb_restored))
